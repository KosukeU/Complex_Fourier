...
df, df_fft = csv_fft(in_file='V1531_signal_abe.csv', out_file='V1531_signal_abe_fft.csv')
...
for i in range(size):
    ...
    ax3.plot(df_fft.T.iloc[0], df_fft.T.iloc[i + 19], label=df_fft.columns[i + 19], lw=1)
    ax4.plot(df_fft.T.iloc[0], df_fft.T.iloc[i + 37], label=df_fft.columns[i + 37], lw=1)
